...
function runPPSAnimation() {
  ...
  const timeline = [
    ...
    { t: "Scen 4 · Avsluta", d: "Projektet avslutas och leveranser godkänns." },
    { t: "DP4", d: "Styrgruppen: Är vi klara?" },
    { t: "Scen 5 · Effektuera", d: "Har nyttan uppnåtts och används lösningen?" },
    { t: "DP5", d: "Beslut om effekthemtagning." },
    { t: "Klart!", d: "Nu har du sett PPS på 40 sekunder." }
  ];
